...
/**
 * Attempts to resize the memory block pointed to by p that was previously allocated.
 *
 * @param p This is the pointer to a memory block previously allocated with malloc,
